...
case_name: Trump v. Cook (Federal Reserve Governor removal)
spawned_from_lrd: LRD-004
sr_review_date: 2026-07-11
principles_exercised: [P13, L6, Sufficient_Assumption_anchor]
hypothesis_touches: {H1: confirmed, H2: confirmed, H3: confirmed, H4: confirmed}
war_chest_candidates: [backdrop-rebuttable-presumption-CATEGORY, historical-tradition-safe-harbor, equity-protects-de-facto-officer, notice-adequacy-three-part]
paired_case_md: Terminal/Central Hub/research/data/legal/cases/trump_v_cook.md
tags: [field-clerk, sr-context, LRD-004, dd-031, removal-doctrine, backdrop-presumption, historical-tradition]
visibility: Public
---

# Field Clerk Draft — 25A312 (Trump v. Cook)

## SR framing — the doctrinal punchline

Cook is Jacobson's shape at constitutional altitude. Same structural move:
...
## The move worth learning — "cause" as centuries-loaded phrase

Two words. Two centuries of common-law weight. The majority's move is to make that weight legible:
...
## The move to name as a category — historical-tradition safe harbor
...
- [x] **P13 — map by function, not label.** Government tried "the President said cause, therefore cause"; majority refuses the label move, maps to the common-law function of "cause." Compare [[24-2242]] where the same discipline strips a pleading label off a jurisdictional escape hatch.
...
> When you see fixed-term + for-cause in a removal statute, load it as a *Reagan/Shurtleff* backdrop presumption — notice and hearing are implicit until Congress speaks clearly to displace them. When you see "cause" or any common-law-pedigreed term, load it as a term of art with centuries of weight. The presumption + backdrop pattern is doing more work in constitutional doctrine than its low profile suggests.

## Cross-references

- **`Terminal/Central Hub/research/data/legal/cases/trump_v_cook.md`** — full synthesis
