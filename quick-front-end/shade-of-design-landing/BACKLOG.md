...
- [x] **NASCAR season standings (top 10 points)**
...
- [x] **Upcoming schedule strip — next 3 races + next 3 NY games**
...
- [x] **Last race / last game result card**
...
- [x] **Knicks & Nets team record + streak widget**
...
- [x] **Driver season stats for featured drivers**
...
- [x] **"On this day" lore cards (static rotating)**
  Expanded: NASCAR lore (14 facts), NBA/NY lore (12 facts), plus live Wikipedia
  API for world events — all three shown as a full-width section below the panels.
...
- [x] **Playoff picture / NASCAR playoff grid**
